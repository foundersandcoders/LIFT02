 ...
 /**
   ...
   */
export function filterLatestResponses(responses: 
Response[]): Response[] {
    ...
    for (const response of responses) {
            ...
            if (!existing || (response.version && existing.version && response.version > existing.version)) {
   ...
   */
export function filterLatestActions(actions: Action[]): 
Action[] {
