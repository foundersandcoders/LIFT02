 ...
 */
export async function getUserShares(userId: string, options?: QueryOptions): Results<Share> {
	let query = supabase
		.from('shares')
		.select('*')
 ...
 */
export async function getSharedWithUser(userId: string, options?: QueryOptions): Results<Share> {
	let query = supabase.from('shares').select('*').eq('shared_with', userId);
 ...
 */
export async function getSharedByUser(userId: string, options?: QueryOptions): Results<Share> {
	let query = supabase.from('shares').select('*').eq('shared_by', userId);
 ...
 */
export async function checkShareAccess(userId: string, shareId: string): Promise<boolean> {
